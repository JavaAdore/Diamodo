...
public class DiamodoResourceBundleUtils {
	...
	public static final String USERNAME_OR_EMAIL_IS_REQUIRED_KEY = "USERNAME_OR_EMAIL_IS_REQUIRED_KEY";
	...
	public static final String FRIEND_ACCOUNT_IS_NO_LONGER_EXIST_KEY = "FRIEND_ACCOUNT_IS_NO_LONGER_EXIST_KEY";

	public static final int SENDER_ACCOUNT_IS_NO_LONGER_EXIST_CODE = -20;
	public static final String SENDER_ACCOUNT_IS_NO_LONGER_EXIST_KEY = "SENDER_ACCOUNT_IS_NO_LONGER_EXIST_KEY";

	public static final int FRIEND_SHIP_REQUEST_ALREADY_SENT_CODE = -21;
	public static final String FRIEND_SHIP_REQUEST_ALREADY_SENT_KEY = "FRIEND_SHIP_REQUEST_ALREADY_SENT_KEY";

	public static final int FRIEND_HAS_SENT_YOU_FRIENDSHIP_REQUEST_YOU_CAN_ACCEPT_IT_CODE = -22;
	public static final String FRIEND_HAS_SENT_YOU_FRIENDSHIP_REQUEST_YOU_CAN_ACCEPT_IT_KEY = "FRIEND_HAS_SENT_YOU_FRIENDSHIP_REQUEST_YOU_CAN_ACCEPT_IT_KEY";

	public static final int SORRY_YOU_CANNOT_SENT_FRIEND_SHIP_REQUEST_TO_THIS_ACCOUNT_CODE = -23;
	public static final String SORRY_YOU_CANNOT_SENT_FRIEND_SHIP_REQUEST_TO_THIS_ACCOUNT_KEY = "  private static final String SORRY_YOU_CANNOT_SENT_FRIEND_SHIP_REQUEST_TO_THIS_ACCOUNT_KEY";

	public static final int YOU_CANNOT_SENT_REQUEST_TO_YOUR_SELF_CODE = -24;
	public static final String YOU_CANNOT_SENT_REQUEST_TO_YOUR_SELF_KEY = "YOU_CANNOT_SENT_REQUEST_TO_YOUR_SELF_KEY";
	...
	public static final String SORRY_YOU_CANNOT_ACCEPT_FRIEND_SHIP_REQUEST_TO_THIS_ACCOUNT_KEY = "SORRY_YOU_CANNOT_ACCEPT_FRIEND_SHIP_REQUEST_TO_THIS_ACCOUNT_KEY";

	public static final int FRIEND_SHIP_REQUEST_IS_NO_LONGER_EXIST_CODE = -27;
	public static final String FRIEND_SHIP_REQUEST_IS_NO_LONGER_EXIST_KEY = "FRIEND_SHIP_IS_NO_LONGER_EXIST_KEY";
	...
	public static final String UPDATE_PROFILE_DTO_SHOULD_NOT_BE_EMPTY_KEY = "UPDATE_PROFILE_DTO_SHOULD_NOT_BE_EMPTY_KEY";

	public static final int UPDATE_PROFILE_MISSING_CLIENT_ID_CODE = -33;
	public static final String UPDATE_PROFILE_MISSING_CLIENT_ID_KEY = "UPDATE_PROFILE_MISSING_CLIENT_ID_KEY";

	public static final int YOU_ARE_TRYING_TO_UPDATE_MEMBER_PROFILE_CODE = -34;
	public static final String YOU_ARE_TRYING_TO_UPDATE_MEMBER_PROFILE_KEY = "YOU_ARE_TRYING_TO_UPDATE_MEMBER_PROFILE_KEY";
	...
	public static final int USER_TOKEN_AND_CLIENT_ID_ARE_REQUIRED_CODE = -37;
	public static final String USER_TOKEN_AND_CLIENT_ID_ARE_REQUIRED_KEY = "USER_TOKEN_AND_CLIENT_ID_ARE_REQUIRED_KEY";
	...
	public static String getValue(String key, Locale locale) {
		...
		try {
			resourceBundle = ResourceBundle
					.getBundle(
							"com.queue.diamodo.common.internationalization.diamodoResouceBundle",
							locale);
		} catch (Exception ex) {  

		}    

		logger.info(String.format("resource bundle of locale %s %s found ",
				locale, (locale == null) ? " not " : ""));
		...
		try {
			...
			logger.info("not able to find value for key " + key
					+ " within locale " + locale);
			return key;
